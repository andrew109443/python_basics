...
time, payment, bonus = map(float, sys.argv[1:])
print(time * payment + bonus)
'''
...
new_list = [num for i, num in enumerate(src_list) if src_list[i] > src_list[i - 1]]
print(new_list)
'''
...
l3 = [i for i in range(100, 1002, 2)]
print(reduce(fun_1, l3))
